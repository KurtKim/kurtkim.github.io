...
의료와 생물의학 분야는 미국의 GDP의 17%를 차지하는 등 비용이 많이 들고, 복잡한 의학 지식을 필요로 한다. 이에 foundation model이 의학 데이터의 다양한 출처에서 학습하여 의학 지식의 중앙 저장소가 될 수 있다. 이 모델은 의료 전문가들이 대화형으로 조회하거나 업데이트할 수 있고, 일반 대중이 조회할 수 있다. 또한, foundation model은 강력한 적응 능력을 가지고 있어, 의료와 생물의학의 다양한 개별 작업에 효율적으로 적응시킬 수 있다. 이를 통해, foundation model은 의료와 생물의학에서 데이터, 작업, 사람 간의 다양한 상호작용을 지원하는 중앙 인터페이스가 될 수 있다.

의료/생물의학 응용은 다중 모달 데이터 통합과 의학의 윤리적, 법적 규정 준수와 같은 독특한 도전 과제를 제시하며, 이는 foundation model에 대한 추가 연구를 필요로 한다. 이러한 도전 과제에 대한 더 자세한 내용은 §3.1.3: healthcare-biomed-challenge에서 설명한다.

#### Opportunities in healthcare.

매년 증가하는 의료 비용과 의료 제공자 부족 등의 문제로 인해 foundation model이 의료 분야에서 중요한 역할을 할 수 있다. 이런 모델들은 진단/치료 보 시스템, 환자 기록 요약, 환자 질문 응답 등의 작업에 효율적으로 적응할 수 있다. 특히, COVID-19와 같은 팬데믹 상황에서는 빠른 진단/스크리닝과 자동화된 질문 응답을 통해 질병 확산을 줄이고 생명을 구하는데 기여할 수 있다. foundation model 통합된 지식 저장소로서, 다양한 의료 분야 작업에 유용하게 사용될 수 있다.

**Interface for healthcare providers.** 의료 제공자들은 불필요한 시간을 전자 건강 기록 편집에 사용하고, 예방 가능한 의료 실수로 인한 낭비가 발생한다. 이 문제를 해결하기 위해, foundation model은 의료 기록에 대한 효율적이고 정확한 인터페이스로 사용될 수 있다. 또한, 환자 방문 요약 작성, 관련 사례와 문헌 검색, 실험실 테스트와 진단, 치료 및 퇴원 제안 등에 도움을 줄 수 있다. 더불어, foundation model은 수술 로봇이 수술을 정확하게 수행하는 데 도움을 줄 수 있다.

**Interface for patients.** foundation model은 환자와의 인터페이스로 사용되어, 진료 정보 제공, 예방 관리 질문 응답, 의학 설명 정보 제공, 그리고 보조 관리 로봇 도움 등을 할 수 있다. 또한, 공중 보건 및 팬데믹 예방에 관한 일반 대중의 질문에 답변하는 역할도 한다. 하지만 이러한 인터페이스는 의료 조언에 대한 신뢰를 보장하기 위해, 사실적 정확성을 보장해야 한다.

#### Opportunities in biomedicine.

foundation model은 생물의학 연구를 촉진하여 약물 발견 및 질병 이해를 돕고, 이는 개선된 의료 솔루션으로 이어진다. 약물 개발은 복잡한 과정을 거치며 큰 비용과 시간이 소요되지만, foundation model의 도입은 이러한 과정을 촉진하고 가속화할 수 있다. 특히, foundation model은 강력한 생성 능력을 통해 실험 프로토콜 생성 및 분자 설계 등의 작업을 돕고, 다양한 데이터 형태의 통합을 통해 생물의학 개념을 다양한 척도와 지식 출처에서 조사할 수 있게 한다. 또한, foundation model은 형태 간 지식 전송을 가능하게 하여, 다른 시퀀스 foundation model에 적응할 수 있다.

**Drug discovery.** 질병을 치료하는 약물이나 치료법을 발견하려면, 연구자들은 먼저 질병과 관련된 대상을 식별하고, 그 대상에 결합해 질병을 치료하는 분자를 찾아야 한다. 이 과정은 보통 비싼 실험실 실험과 수년이 소요되지만, foundation model의 생성 능력은 검색 공간과 효율성을 향상시켜 실험의 양을 줄이고 새롭고 더 나은 약물을 발견하는데 도움이 된다. 또한, 단일 foundation model을 사용해 대상 식별, 효능 예측, 부작용 예측 등의 관련 약물 발견 문제를 동시에 해결하면, 각 해결책을 개선할 수 있다. 특히, foundation model은 언어 모델을 사용한 단백질 모델링 분야에서 치료법 설계에 중요한 영향을 미칠 수 있는 잠재력을 보여주고 있다.

**Personalized medicine.** 개인 맞춤 의학은 각 환자의 건강 이력, 유전자, 영상 등을 기반으로 최적의 치료법을 선택합니다. foundation model은 주어진 여러 약물과 환자 게놈에 따라 어떤 약물이 최소한의 부작용으로 환자를 치료할 가능성이 가장 높은지 예측하는 데 도움이 될 수 있다. foundation model은 전자 건강 기록부터 의료 영상, 약물 및 분자 측정치 등 다양한 환자 데이터를 통합하여 최적의 예측을 하는데 독특한 장점을 가지고 있다.

**Clinical trials.** 임상 시험은 치료법이나 약물 후보의 효과와 안전성을 연구하는데, 기존의 방법은 비효율적이고 비용이 많이 든다. foundation model은 기존 연구를 바탕으로 잠재적인 실패를 예측하고 유망한 임상 시험 프로토콜을 설계하는데 도움을 줄 수 있다. 또한, 환자의 개인 프로필을 바탕으로 자격이 있는 환자를 자동으로 매칭하는 작업에도 활용될 수 있다.

#### Challenges and future research in foundation models.

헬스케어와 생물의학 분야에서는 foundation model의 도움이 있지만, 이 분야에서는 추가적인 연구가 필요한 독특한 도전과제들이 존재한다.

**Multimodality.** 의료 데이터는 다양한 유형, 규모, 스타일로 구성되어 있다. 현재의 self-supervise 학습 모델은 각 데이터 모드에 대해 개별적으로 개발되어 있지만, 다양한 모드에서 공동으로 학습하지는 않는다. 다양한 다모드 의료 데이터에서 모드 간 및 교차 모드 정보를 학습하기 위해, foundation model의 학습에서 특징 수준과 의미 수준의 통합 전략을 모두 조사해야 한다. 이를 효과적으로 수행하면, 생물의학적 지식의 통합과 발견 촉진에 기여할 수 있다.

**Explainability.** 의사결정에 대한 증거와 논리적인 단계를 제공하는 설명 가능성은 헬스케어와 생물의학 분야에서 중요하며, GDPR에 의해 필수적이다. 이는 환자의 증상과 시간적 관련성 등을 증거로 제시하며, 시스템과 전문가 간의 불일치 문제를 해결하는 데 도움이 된다. 그러나 현재의 foundation model은 설명 가능성을 포함하지 않아 이에 대한 추가 연구가 필요하며, 지식 그래프의 도입은 이를 향상시키는 방향으로 작용할 수 있다.

**Legal and ethical regulations.** 헬스케어 응용 프로그램은 환자 안전, 개인정보 보호, 공정성 등을 보장하는 법과 윤리를 준수해야 한다. foundation model의 예측은 의학적 지식에 정확해야 하며, 불확실한 경우 전문가에게 의결을 맡겨야 한다. 환자의 건강 기록 사용은 개인정보 보호법을 준수해야 하며, 연합 학습은 개인정보를 보호하는 방법 중 하나이다. 공정성을 위해 연구자들은 데이터가 다양한 성별, 인종, 민족, 사회경제적 배경을 대표해야 하며, 데이터가 부족한 경우 모델에서 편향을 제거하는 연구가 필요한다. foundation model 개발자들은 특정 상황에서의 법규를 준수하며, 윤리와 법 연구자들과 상의해야 한다.

**Extrapolation.** 생물의학 발견 과정은 새로운 실험 기술이나 새로운 환경에 빠르게 적응하는 외삽을 필요로 하다. 이는 생물의학에서의 주요 머신러닝 도전 과제이며, GPT-3 같은 foundation model이 이를 수행하는 능력은 아직 초기 단계에 있다. 헬스케어와 생물의학의 다양한 데이터와 작업을 고려할 때, foundation model의 extrapolation 능력을 향상시키는 추가 연구가 필요하다.

### Law

법의 영역은 광대하며, 미국에서는 130만 명 이상의 변호사가 활동하고 있다. 그러나, 높은 법률 서비스 비용으로 인해 저소득층의 86%는 충분한 법률 도움을 받지 못하고 있다. 변호사들은 과도한 업무와 인력 부족으로 곤란한 상황에 처해 있다. 이로 인해 법률 서비스에 대한 접근성이 저하되어 사회적 문제가 되고 있다. 이러한 문제를 해결하기 위한 노력이 필요하다는 의견이 많이 제기되고 있다.

foundation model은 법률 서비스에 대한 절차적이고 경제적 장벽을 줄이는 방식으로 공정한 접근성을 증진시킬 수 있는 잠재력을 가지고 있다. 법률 분야는 특수한 언어를 사용하고, 모호하고 불명확한 기준을 다양한 사례에 적용하는 경우가 많아, 컴퓨터 해결책에 독특한 도전을 제기한다. 또한 레이블이 붙은 학습 데이터 비용이 높아 부족한 상황이지만, foundation model의 유연성과 소수의 예제로부터 배움을 통해, 이러한 도전을 해결하는 데 독특한 위치를 가질 수 있다.

이 섹션에서는 foundation model이 다양한 형태의 맥락(재판의 오디오, 증거 발견의 비디오 및 이미지, 법률 연구의 텍스트 등)을 증거로 활용할 수 있음을 설명한다. 그러나 대부분의 법률 작업에서는 텍스트 기반의 입력과 출력에 foundation model이 주로 사용된다. 미국 민사 소송의 단계를 설명하는 그림과 법률 서한의 일부를 생성하는 로직 흐름을 보여주는 그림을 통해, foundation model이 어떻게 이 과정에 도입될 수 있는지를 구체적으로 보여준다.

진행하기 전에, foundation model을 법률이나 정부 분야에 적용하기 전에 윤리, 법률적 적합성, 공정성에 대한 중요한 고려사항들을 반드시 검토해야 한다. 이러한 응용 분야들은 실제 세계에서 큰 영향을 미치며, 특히 투명성, 책임성, 설명 가능성에 중점을 두는 법률 시스템에서는 더욱 그렇다. 현재의 모델들이 이러한 법률 문제들을 해결하는 데 충분한지에 대해서는 의문이 있지만, 법률 및 정부 서비스에 대한 접근성을 개선하는 것은 분명히 가치 있는 목표이다.

#### Opportunities in law.

기계 학습은 다양한 법적 맥락에서 활용되며, 이는 정부 활동에서부터 법률 서비스 제공에 이르기까지 다양하다. 최근 법률 AI 연구는 미국 외 지역에 중점을 두고 있지만, 전문성은 주로 미국 법률 시스템에 초점을 맞추고 있다. 특히, 미국 법률 시스템에서 foundation model이 유익할 수 있는 주요 법적 응용 영역은 사법, 형사법, 그리고 공법이다.

**Civil law.** 미국의 민사 소송에서는 대리인을 위해 변호사를 고용해야 하며, 이로 인해 많은 저소득자들이 적절한 법률 대표를 구하는 데 어려움을 겪는다. foundation model은 법률 서비스의 비용을 줄이고 품질을 향상시키며 범위를 확장함으로써 접근 가능한 법정을 개선하는 가능성이 있다. 이러한 모델은 민사 소송이 제기되는 과정에서 변호사와 판사 모두를 돕는 역할을 할 수 있다.

변호사 참여 전에도, 클라이언트들은 foundation model을 사용해 이익을 볼 수 있다. 최근 연구에서는 머신러닝을 이용해 클라이언트의 문제를 분석하고, 필요한 법률 행동이나 전문 변호사를 추천한다. 이 같은 도구들은 클라이언트의 특별한 요구에 맞는 정보를 제공하여 법률 접근성을 높이는 데 도움이 된다.

변호사들은 민사 소송 전에 많은 과정을 거치며, 이를 통해 비용이 많이 드는 재판을 피하려고 노력한다. 이 과정에서는 계약 평가, 서비스 조항 검토, 관련 특허 찾기 등이 포함되며, 이 모든 것을 수행하기 위해 foundation model을 활용한다. 최근 연구에 따르면, foundation model을 활용한 법률 문서 검토는 도전적이지만, 이를 통해 법률 서비스 제공의 비용과 장벽을 줄일 수 있다.

그러나 법률 문서의 번역은 정확성과 고도의 기술적 언어 이해가 필요하며, 이로 인해 학습 데이터를 수집하는데 큰 비용이 발생한다. 이에 따라, foundation model은 데이터 부족한 상황에서 빠르게 적응하여, 완전히 감독된 메커니즘보다 이 영역에서의 성능을 개선할 수 있다.

foundation model은 법률 분야에서 다양한 역할을 수행하며, 이는 비용 절감과 서비스 향상에 기여할 수 있다. 연구에 따르면, 이러한 모델은 법률 텍스트 작성 시 관련 인용문과 판결문 추천, 법률 검색 엔진 개선, 계약서 작성 및 검토 자동화 등에 활용되었다. 특히, 변호사들이 법률 서면을 작성하는 데 있어서 foundation model이 큰 도움을 줄 수 있다. 이는 새로운 주장을 찾거나 서면의 문제점을 파악하는 데 유용하며, 서면이 어떻게 개선되어야 유리한 결과를 얻을 수 있는지에 대한 상세한 조언을 제공할 수 있다.

서면 절차가 시작되고 변호사들은 문서 검토를 위해 머신러닝을 활용한다. 이 문서들은 다양한 형태(비디오, 이미지, 오디오, 텍스트 등)를 포함하고 있다. 현재의 시스템은 지도학습과 액티브 학습을 사용해 문서를 분류하기 때문에 비용이 많이 든ㄴ다. 그러나 foundation model을 사용한 few-shot 또는 zero-shot 문서 검색 기능은 이러한 비용 문제를 완화할 수 있다. 게임이 정보 취득 과정을 방해하지 않도록 Cui는 foundation model만이 가능하게 하는 zero-shot 또는 few-shot 적응 과정을 제안하였다.

재판이 시작되면, foundation model은 판사의 이전 의견을 바탕으로 심문에 집중할 부분을 예측하여 당사자들의 준비를 돕는다. 법정에서는, foundation model이 법정 절차의 오디오와 비디오를 분석해 피고인에 대한 결과가 인종이나 방언 때문에 편향되었는지를 판단하는 데 사용될 수 있다.

재판이 끝나면, foundation model은 판사와 법률 사무원이 양측의 법적 주장을 평가하는 데 도움이 될 수 있다. 또한, 이전의 연구와 같은 방법을 통해 항소 결정을 예측하거나, 판사들의 결정 초안 명백 오류를적하는 사용될 수 있다. 또한, 이러한 모델은 법적 의견에서의 인종 편향을 식별하고, 판사들이 그에 따라 의견을 수정하는데도 도움이 된다.

**Criminal law.** 형사법 분야에서 정부의 위험 점수 사용은 언어 데이터의 편향 가능성 때문에 매우 민감한 문제이다. 그럼에도 불구하고, foundation model은 검사와 변호인이 업무 효율을 높이고 자원 제약을 줄이는 데 도움을 줄 수 있다. 이는 특히 자금과 인력이 부족한 공공 변호인에게 유용할 수 있으나, foundation model만으로 모든 문제를 해결할 수는 없다.

foundation model은 구조적 불평등을 줄이는 감독 역할을 할 수 있다. 이들은 가석방 청문회 기록 분석, 경찰 보고서에서 인종 단서 제거, 무례한 경찰 커뮤니케이션 식별 등에 사용되어 불공정을 방지한다. 데이터 라벨링의 높은 비용 문제를 해결하기 위해, 이 모델들은 라벨이 적은 상황에서도 효율적으로 적응하고 사전 학습될 수 있다.

**Public law.** 정부 기관은 사회 다양한 부문을 규제하며, foundation model은 이러한 과정에서 넓은 활용 가능성을 가진다. 공공 의견 분석, 특허 심사 지원, 정보 자유 법 요청 문서 검색, 대규모 판정 지원 등 다양한 영역에서 foundation model이 정부 서비스의 질, 효율성, 유용성, 접근성을 향상시킬 수 있다. 이러한 모델의 적응성과 유연성은 자원이 제한되고 맥락이 변화하는 환경에서 특히 중요하다. 예를 들어, 공공 의견 포럼에서의 중재를 개선하기 위해 NLP 기술이 활용되었다. 그러나 정부 기관은 이러한 기술을 사용할 때 헌법적, 법적, 행정적 의무를 준수해야 하며, 이에 따라 추가적인 주의가 필요하다.

#### How can foundation models uniquely help?

법적 응용 분야에서는 데이터 주석 비용이 높고, 전문가의 도움이 필요하며, 민감한 데이터로 인해 학습이 어려울 수 있다. 이러한 상황에서 Brown et al. (2020)의 few-shot 학습 기술을 활용한 foundation model이 제한된 데이터로도 효과적인 학습 방법으로 부상하고 있다.

법적 의사결정은 다양한 수준의 맥락적 지식을 요구한다. foundation model은 이러한 맥락을 학습하고, 개별 사건을 정밀하게 모델링하는 데 필요한 언어적 능력을 제공할 수 있는 잠재력을 갖고 있다.

#### What are foundation models lacking that requires more research?

실제 적용을 위해 foundation model이 해결해야 할 문제를 이해하기 위해, 법원에 제출할 법적 요약문 자동 생성을 예로 들 수 있다.

요약문은 심리 전 판사에게 주장을 전달한다. 당사자가 요약문을 제출하고, 상대방이 응답하면, 판사가 심리에서 질문 후 결정을 내린다. 

자동 요약문 생성 시스템은 변호사가 제공한 사건 정보와 원하는 결과 개요를 바탕으로, 법원 제출용 복잡한 법적 요약문을 만든다.

장문 문서와 서술을 처리하기 위해, 모델은 긴 맥락과 긴 내용을 다룰 수 있어야 한다. 법적 문서는 매우 길며, 미국 대법원 의견부터 재판 기록에 이르기까지 다양한 문서가 수천 단어에서 수백 페이지에 달할 수 있다. 현재의 foundation model들은 이러한 긴 맥락과 내용을 처리하는 데 어려움을 겪고 있다.

foundation model은 사례별 문서를 넘어 관련 판례법을 검색하고, 유효성 여부를 판단해야 한다. 학습 이후 발생한 개념 변화를 고려하며, 판례법의 발전에 따라 정보를 업데이트하는 작업이 필요하다. 또한, 검색된 법적 기준을 바탕으로 설득력 있는 논증을 구성하는 방법을 이해해야 하며, 이를 위한 연구가 진행 중이다.

Holzenberger et al. (2020)은 세금 코드를 이용하여 모델의 법적 추론 능력을 평가하는 연구를 진행하였다. 이 연구에서는 도메인 전문가가 프롤로그 솔버를 사용해 개인의 세금 책임을 정확히 결정할 수 있음을 보여주었지만, 법률 텍스트에 사전 학습된 BERT 모델만으로는 관련 규칙을 적절히 추론하고 적용하는 데 충분하지 않다는 결론을 내렸다.

GPT-3와의 실제 교류를 통해 현재 모델이 법적 추론과 같은 간단한 작업도 수행하기 어려움을 보여준다.

*Precision.* foundation model이 가짜 사실 생성 문제를 해결하지 못하는 것은 현재 모델의 한계이다. 법적 상황에서 정확성과 진실성이 매우 중요하며, 부정확하거나 거짓된 진술은 큰 문제를 일으킬 수 있다.

*Few-shot Learning.* 적은 예시로 학습하기는 foundation model이 직면한 주요 도전 중 하나이며 아직 초기 단계이다. 법적 문서에 대한 이해를 높이기 위한 연구와 함께 중요하며, 한 분야에서 얻은 지식을 다른 분야에 어떻게 적용할 수 있는지는 아직 명확하지 않다.

*Adaptation.* 도메인 적응형 사전 학습을 통해 라벨 없는 법적 코퍼스에서 향상이 관찰되었으며, 이는 특히 사전 학습 코퍼스가 downstream 작업과 밀접할 때 더욱 두드러진다. 다양한 법적 작업에의 적용 가능성은 아직 확실히 연구되지 않았지만, 이 방법은 적은 예시 학습의 보완적 개선을 제공할 수 있다.

*Access to Clean In-Domain Data.* 최근 법률 벤치마크 작업을 위한 대규모 라벨링 데이터셋 생성 노력이 있었다. 이는 더 큰 언어 모델이 더 많은 데이터에 사전 학습될 때 특정 어려운 작업에서 성능이 향상됨을 보여주었다. 그러나, 법적으로 의미 있는 NLP 작업을 위한 데이터셋 생성은 비용이 많이 드는 인간의 주석이 필요하거나, 법적 텍스트의 특수성을 제대로 반영하지 못하는 자동화 방법으로 인해 어렵다. 이로 인해 많은 법률 도메인 특정 데이터셋은 작거나 공개되지 않았으며, foundation model 개발 이전의 방법으로 해결된 단순한 작업을 반영하고 있다.

대부분의 법률 데이터가 대표적이지 않을 수 있다. 이는 소수의 사건만 법적 의견으로 남고, 대형 법률 회사에서만 더 대표적인 데이터를 축적할 수 있기 때문이다. 이로 인해 소수의 자원이 풍부한 행위자만이 모델을 학습시킬 수 있어 권력이 더욱 집중될 우려가 있으나, 모델이 잘 일반화할 수 있으면 이 문제를 해결할 수 있다.

*Reliability.* foundation model이 법률 분야에서 모든 작업을 성공적으로 수행하더라도, 실제 배포는 큰 도전이며, 실패는 고객과 변호사에게 해로운 결과를 초래할 수 있다. 이 때문에 기계 번역 소프트웨어는 일부 법원에서 신뢰할 수 없는 증거로 여겨지지만, 여전히 다른 곳에서는 사용되고 있다.

법률 브리핑과 추론은 현재 기술로는 어렵지만, 미래에는 가능할 것으로 보이며, 이는 foundation model 개발의 방향을 제시한다.
